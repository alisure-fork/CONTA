...
if __name__ == '__main__':
    ...
    parser.add_argument("--voc12_root", type=str, default="/media/ubuntu/4T/ALISURE/Data/L2ID/data", help="Path")
    ...
    parser.add_argument("--cam_batch_size", default=32 * 4, type=int)
    ...
    parser.add_argument("--irn_batch_size", default=8 * 4, type=int)
    ...
    parser.add_argument("--exp_times", default=8, help="The number of random walk iterations 2^{exp_times}.")
    parser.add_argument("--ins_seg_bg_thres", default=0.25)
    parser.add_argument("--sem_seg_bg_thres", default=0.25)

    # Output Path
    runner_name = "2"
    parser.add_argument("--log_name_dir", default="sess/{}".format(runner_name), type=str)
    parser.add_argument("--cam_weights_name", default="sess/{}/res50_cam.pth".format(runner_name), type=str)
    parser.add_argument("--irn_weights_name", default="sess/{}/res50_irn.pth".format(runner_name), type=str)
    parser.add_argument("--cam_out_dir", default="result/{}/cam".format(runner_name), type=str)
    parser.add_argument("--ir_label_out_dir", default="result/{}/ir_label".format(runner_name), type=str)
    parser.add_argument("--sem_seg_out_dir", default="result/{}/sem_seg".format(runner_name), type=str)
    parser.add_argument("--ins_seg_out_dir", default="result/{}/ins_seg".format(runner_name), type=str)
    ...
    os.makedirs("sess/{}".format(runner_name), exist_ok=True)
    os.makedirs(args.log_name_dir, exist_ok=True)
